...
const hant: Record<string, DiscoverStoryI18n> = {
  "clear-email-elon": {
    title: "清掉你的郵件",
    headline: "Elon 今天在 X 指 Grok Bot 去做九萬封郵件大掃除",
    whatTheyDid:
      "2026 年 8 月 19 日，Elon 引用 Mike P（@mikepat711）：Grok Bot 正在走兩個 Gmail 賬戶——大約九萬封郵件——刪掉 Mike 自己從來不敢動的垃圾。Elon 一句話就是產品提示：「Clear your email with @Grok @Bot。」",
    howItWorks:
      "這不是發布演示。一個真人把兩個正在用的收件箱交給 Grok Bot，叫它清。Elon 同一個早上轉發。我們保留 Elon 原帖。沒有在這裡重跑那九萬封。",
    whyUseful: "清理收件箱是人人都懂的 Grok Bot 工作。如果你盯着十年 Gmail 不敢動，這就是今天熱度最高的公開例子。",
    whyItMatters: "今天 Elon 時間線上最熱的 Grok Bot 帖——幾小時幾百萬觀看。工作是 Mike 的；熱度是 Elon 的。兩邊都寫清楚。",
    whoShouldTry: ["收件箱炸掉的人", "創始人", "運營"],
    usefulFor: "被 Gmail 淹沒的人",
    quote: "Clear your email with @Grok @Bot",
    result: "九萬封郵件 · 兩個 Gmail",
  },
  "week-of-hacks-nate-herk": {
    title: "一周 Grok Bot 技巧",
    headline: "Nate Herk 今天寫了九個 Grok Bot 技巧——Elon 問「What’s ur @Bots？」",
    whatTheyDid:
      "Nate Herk 在 X 發表〈A Week of Grok Bot Lessons in 10 Mins〉：九個把默認 Bot 變成一隊的做法。Elon 同一個早上引用，問大家在跑什麼 Bot。",
    howItWorks:
      "他的做法：Grill Me 技能採訪你、抽出背景；Klaus 做幕僚長，你只跟一隻 Bot 聊；專員 Motion、Eyes、Miner、Coffee、Views；共享記憶對私人記憶；Composio 接更多 app；ClickUp 避免工作消失在聊天；示範一次就教會；例行工作；已登錄的瀏覽器配置。我們摘要公開文章——沒有重跑 Klaus。",
    whyUseful: "這是今天人們在收藏的設置文。如果你已經開了 Bot，但仍然覺得只是多一個聊天室，從這裡開始。",
    whyItMatters: "Elon 沒有再發一個新流程。他指着這篇。文章是工作；Elon 那句問就是它出現在每條時間線的原因。",
    whoShouldTry: ["已經有 Bot 的人", "想組一小隊的運營", "創作者"],
    usefulFor: "運營 / 創作者",
    quote: "What’s ur @Bots?",
    result: "九個技巧 · 一隻幕僚長",
  },
  "household-bots-blake-king": {
    title: "頭 48 小時，不用會 code",
    headline: "Blake King 零編程試 Grok Bot——Elon 今天轉發",
    whatTheyDid:
      "Blake 接了公開挑戰，跳過 OpenClaw，兩個晚上：接郵件、讓 Bot 做一份 12 頁家庭預算 PowerPoint、爲太太生意開一隊 Bot、再每天收 Tesla 新聞摘要。",
    howItWorks:
      "他說產品會一步步帶你設置。不用寫 code。先郵件，再預算幻燈片，再一小隊，再早報。Elon 在 2026 年 8 月 19 日轉發。我們沒有重跑他的 Bot。",
    whyUseful: "多數發布帖當你已經會用 agent。這篇是非工程師，講頭幾份真正交得出的活。",
    whyItMatters: "今天它和清收件箱、Nate 的技巧一起出現在 Elon 時間線。現在討論的就是：人用 Grok Bot 做家庭和小生意的真工作。",
    ...
    result: "12 頁預算幻燈片 · 48 小時，不用 code",
  },
  "grok-bot-launch-bot": {
    title: "Grok Bot 上線",
    headline: "@bot 介紹 Grok Bot：擁有自己電腦的 AI 隊友",
    whatTheyDid:
      "官方 @bot 賬號宣布 Grok Bot 進入早期測試：每隻 Bot 有自己的電腦，登錄你已經在用的工具，需要批准時才回來找你。",
    howItWorks:
      "這是產品發布帖，不是單一流程。後來的官方例子——銷售外展、收件箱、CRM、工程——都掛在這條原文上。我們保留原帖鏈接，再用白話講清楚它在說什麼。",
    whyUseful: "如果你剛接觸 Grok Bot，先看這裡，再複製提示詞。",
    whyItMatters: "之後很多 Grok Bot 文章都會指回這條宣布。短摘要加原帖，快過自己刷回復。",
    whoShouldTry: ["正在評估 Grok Bot 的人", "決定要不要訂閱的創始人"],
  ...
  "overnight-sales-xai": {
    title: "通宵銷售外展",
    headline: "xAI 用 Grok Bot 通宵研究客戶，早上只留待審批的草稿",
    whatTheyDid:
      "一隻銷售外展 Bot 會通宵研究賬戶、按意向給聯繫人打分，再用每位銷售的語氣起草郵件和 LinkedIn，早上只留一疊等你批准的草稿。",
    howItWorks: "Bot 趁你睡覺用瀏覽器和現有銷售工具開工。早上你審的是草稿，不是還要自己變成郵件的對話摘要。",
    whyUseful: "適合創始人和 SDR：站會前管道工作已經做好，但又不會讓 Bot 未經審批就寄出。",
    whyItMatters: "這是官方旗艦例子。重點是：做完的工作落到真正的收件箱。",
    whoShouldTry: ["SDR", "自己做外展的創始人", "銷售主管"],
    usefulFor: "銷售 / 創始人",
    quote: "researches accounts overnight, scores contacts with intent, drafts email and LinkedIn in each seller’s voice",
    result: "通宵研究 · 早上只留待審批草稿",
  },
  "crm-notes-xai": {
    title: "通話後更新 CRM",
    headline: "xAI 用銷售 Bot 把通話逐字稿寫進 CRM",
    whatTheyDid: "在 SpaceXAI 內部，一隻銷售 Bot 會用通話逐字稿更新 CRM，並起草跟進，記錄留在人類本來就會用的工具裏。",
    howItWorks: "通話後 Bot 讀逐字稿、寫字段和下一步，放進 CRM。改交易階段或數字仍然要人批准。",
    whyUseful: "CRM 腐爛很安靜、也很貴。把筆記寫進真正的系統，好過摘要留在聊天室。",
    whyItMatters: "xAI 自己說：工作還沒放到隊友會放的位置，就不算做完。這就是銷售運營版。",
    whoShouldTry: ["客戶經理", "銷售運營", "自己兼 CRM 的創始人"],
    usefulFor: "銷售運營 / 客戶經理",
  ...
  "inbox-organizer-xai": {
    ...
    whatTheyDid: "SpaceXAI 團隊會疊幾隻 Bot：上面一隻幕僚長，下面有專責收件箱的一條線，不必一隻 Bot 包辦所有事。",
    howItWorks: "一隻 Bot 負責收件箱：分類、草稿、提醒你丟掉的對話。另一隻可以坐在上面，只在要判斷時拉你進場。",
    whyUseful: "多數人不需要 12 只 Bot 的組織圖。他們需要一隻讓早上 Gmail 小一點的 Bot。",
    whyItMatters: "官方模型是一小隊 Bot，不是一隻萬能代理。收件箱是幾乎人人都懂的那條線。",
    whoShouldTry: ["創始人", "運營", "收件箱等於工作的人"],
    usefulFor: "運營 / 創始人",
  ...
  "expense-manager-xai": {
    title: "開支管家",
    headline: "xAI 把開支交給一隻 Bot，收據就不要再躺在 Gmail",
    whatTheyDid: "官方例子包括開支專員，以及一隻運營 Bot 處理 Gmail 收到的發票，再寫進財務已經在用的工具。",
    howItWorks: "Bot 看收件箱裡的收據和發票、抽出事實、更新表格或財務工具。看起來像付款的，仍然要你批准。",
    whyUseful: "收據放久了就難找。每天掃一次，好過月底再用 Gmail 搜索翻箱倒櫃。",
    whyItMatters: "這是不性感的官方工作——重點就在這裡。Grok Bot 賣的是沒人想重做的隊友工作。",
    whoShouldTry: ["創始人", "辦公室主任", "小型財務團隊"],
    usefulFor: "運營 / 財務",
  ...
  "bug-reproduction-xai": {
    title: "復現 Bug",
    headline: "xAI 用工程 Bot 在產品界面復現 bug，再提單",
    whatTheyDid: "一隻工程 Bot 會在產品界面復現 bug、提單，再把修復交給調試 Bot——報告就不再是一句含糊的 Slack。",
    howItWorks: "有人描述 bug。Bot 打開產品、走一遍步驟、寫下看到了什麼，再提到團隊已經在用的跟蹤器。",
    whyUseful: "適合小工程團隊：報告者已經撞過一次的 bug，不要再花時間重找。",
    whyItMatters: "官方工程例子不多。這個很具體：復現、提單、交接——不是「幫我寫代碼」。",
    whoShouldTry: ["工程師", "QA", "兼做支持的創始人"],
    usefulFor: "工程 / QA",
  ...
  "vendor-negotiation-xai": {
    ...
    whyUseful: "當談判主要是郵件、而且重複，又想語氣像你，就合適。",
    whyItMatters: "這是官方團隊例子，不是具名客戶案例。我們留下是因爲工作很具體——而且涉及錢的郵件，最後一下仍應是人。",
    whoShouldTry: ["創始人", "運營主管", "要買軟件或服務的人"],
    usefulFor: "創始人 / 運營",
  ...
  "store-support-xai": {
    ...
    whatTheyDid: "Grok Bot 團隊的早期例子包括處理網店顧客支持——分類、草稿、更新，都在店鋪已經在用的工具裏做。",
    howItWorks: "Bot 讀新工單或郵件、分組、起草回復。發布或退款先留給你，直到你信任這條線。",
    whyUseful: "適合小店：客服是創始人半夜回，不是 20 人客服臺。",
    whyItMatters: "支持量大，只要最後一下留給人，就容易還原。這符合 xAI 講 Bot 應該接的工作。",
    whoShouldTry: ["網店創始人", "支持主管", "一個人撐場的運營者"],
    usefulFor: "支持 / 創始人",
  ...
  "reddit-thread-scout-axel": {
    title: "Reddit 帖子偵察",
    headline: "Axel Schapmann 用 Grok Bot 做 Reddit 營銷——找值得加入的帖，不是刷屏",
    whatTheyDid:
      "Axel 寫過用 Grok Bot 做 Reddit 營銷：找你真能幫上忙的新帖，以及仍然排得上名的舊帖，然後停在評論草稿。",
    howItWorks: "把網站、產品和幾個競品交給 Bot。它搜 Reddit 和 Google，評匹配度和刷屏風險，留言留給你自己發。",
    whyUseful: "找到對的帖才是慢的部分。進對房間，寫評論就容易。",
    whyItMatters: "這是公開的社群文章，不是 xAI 截圖。我們整理成卡片和可複製流程——沒有在這裡重跑他的 Bot。",
    whoShouldTry: ["創始人", "市場人員", "獨立開發者"],
    usefulFor: "市場 / 創始人",
    output: "帖子清單 + 評論草稿",
  },
  "travel-concierge-nate": {
    title: "旅行管家",
    headline: "Nate 用 Grok Bot 計劃旅行——他一天內開了十二隻 Bot，這是其中一份工",
    whatTheyDid: "Nate 在公開評測裏大約八小時開了一隊 Bot。旅行計劃是其中一份工，還有運動和聯繫人研究。",
    howItWorks: "你給日期、預算和限制。Bot 比較公開選項，寫出一天一天的計劃。下單仍然是你。",
    whyUseful: "旅行研究很快變成 40 個標籤頁。交回一份短簡報，才是非技術用戶用得上的版本。",
    whyItMatters: "Nate 的標準是「做完」，不是「叫你做」。旅行是清楚的個人例子——也提醒 Grok Bot 不只是銷售工具。",
    whoShouldTry: ["忙的專業人士", "家庭", "討厭 40 個標籤頁研究的人"],
    usefulFor: "要計劃旅行的人",
  ...
  "youtube-comments-remy": {
    title: "YouTube 評論臺",
    headline: "Remy 讓內容 Bot 開始回 YouTube 評論",
    whatTheyDid: "Remy 做了一隻叫 Gordon 的內容 Bot。現場試過之後，Gordon 開始按行程起草 YouTube 評論回復——最後一下仍是 Remy。",
    howItWorks: "把視頻或頻道交給 Bot。它把評論分組，用你的語氣寫短回復。聽起來像你的，才由你發布。",
    whyUseful: "有用的問題會被表情蓋過。每天一桌，好過想起才打開 YouTube Studio。",
    whyItMatters: "這是具名的人、具名的 Bot、公開寫出來。我們摘要這份工作；不會說我們重測過 Gordon。",
    whoShouldTry: ["創作者", "教育者", "產品營銷"],
    usefulFor: "創作者 / 內容",
  ...
  "newsletter-to-social-remy": {
    title: "通訊轉社交",
    headline: "Remy 用內容 Bot 把上周通訊改寫成 X 和 LinkedIn 帖",
    whatTheyDid: "同一隻內容 Bot Gordon，把上周通訊改寫到 X 和 LinkedIn。Remy 說現在自動跑，幾乎不用再教。",
    howItWorks: "Bot 讀那期內容，按平臺長度用你的語氣寫帖，留草稿。你再發布。我們對應的流程會在發布前停。",
    whyUseful: "內容已經有了。稅是改三次格式。這份工作適合交給 Bot。",
    whyItMatters: "社群例子最好有 Bot 名和產出。這篇兩樣都有。",
    whoShouldTry: ["寫通訊的人", "會發帖的創始人", "內容主管"],
    usefulFor: "內容 / 創始人",
  ...
  "monday-marketing-report-jellypod": {
    title: "星期一市場報告",
    headline: "Jellypod 第一個 Grok Bot 市場玩法，是星期一巡一圈儀錶盤",
    whatTheyDid:
      "Jellypod 的公開指南從你每周已經在做的匯報開始：走一遍 GA4、廣告、排名和郵件，抄你點名的數字，留一頁簡報。",
    howItWorks: "示範巡迴一次。排星期一早。只有指標越過你設的線，Bot 才吵你。",
    whyUseful: "星期一早上還不知道上周行不行，已經登錄六次。填好的簡報，好過再開一個儀錶盤。",
    whyItMatters: "這是實務指南，不是病毒截圖。我們留下是因爲工作悶、每周都做、又容易抄。",
    whoShouldTry: ["市場經理", "創始人", "代理公司負責人"],
    usefulFor: "市場 / 創始人",
  ...
  "competitor-monitor-jellypod": {
    title: "競品監控",
    headline: "Jellypod 寫過每周用 Grok Bot 巡競品網站和廣告庫",
    whatTheyDid:
      "同一篇指南的第二個玩法：教 Bot 每周走一份固定清單——廣告庫、評論站、競品更新——只標出真正變了的。",
    howItWorks: "你示範清單一次。Bot 記下差額：新承諾、價格改、評論裏新出現的反對——留題材，不是倒出 40 頁。",
    whyUseful: "適合創始人和市場團隊：不想每天人手打開競品網站。",
    whyItMatters: "競品監控是人們最先問的例子。這個版本有來源、改錯回得去，也對應完整 UseGrokBot 流程。",
    whoShouldTry: ["創始人", "市場團隊", "產品營銷"],
    usefulFor: "市場 / 創始人",
  ...
  "one-person-company-rahul": {
    title: "一人公司",
    headline: "Rahul 寫了怎樣用 Grok Bot 跑一人公司——從找客到每周匯報",
    whatTheyDid:
      "2026 年 8 月 19 日，Rahul（@sairahul1）在 X 發表文章〈How To Build a One-Person Company Using Grok Bot〉。開頭就是一人公司的負荷——找客、寫外展、做圖、回復、數一星期——再用 Bot 系統接手這些線。",
    howItWorks:
      "他講設置、插件、每隻 Bot 一份章程、示範一次就變成例行工作，以及六個起步角色（幕僚長、Scout、Quill、Forge、Guide、Ledger）。我們摘要公開文章——沒有重跑他的公司棧。附近一條流傳的 Elon 鏈接其實引用了另一篇 Grok Bot 帖，所以我們保留 Rahul 原文。",
    whyUseful: "這是今天人們在打開的長文：「一工一隻 Bot」。如果你就是整間公司，從這裡開始。",
    whyItMatters: "今天 X 上最熱的社區 Grok Bot 指南。是打法，不是客戶截圖。我們保留 Rahul 原帖。",
    whoShouldTry: ["一人創始人", "自己就是整間公司的運營", "已經在付 Grok Bot 的人"],
    usefulFor: "一人創始人 / 運營",
  ...
  "podcast-summarizer-gavin-baker": {
    ...
    whatTheyDid:
      "2026 年 8 月 17 日，Gavin Baker（@GavinSBaker）寫 @bot 是 AI 的另一個 「Claude Code」 moment，個人 AI 用量大概增加了 100 倍。具體的活：之前有人問他怎麼做 Podcast summarizer。在 Grok Bot 裏大約十五秒就做好，而且比他之前用的更好。",
    howItWorks: "這是具名投資人交出的第一份真活，不是發布演示。我們保留 Gavin 原帖。沒有重跑他的摘要工具。",
    whyUseful: "每天一堆 Podcast，是投資人和運營已經有的活。這就是公開例子：交給 Bot，而不是再做一套自己的工具。",
    whyItMatters: "這周最受注意的社區 Grok Bot 用例帖之一。社區；沒有標已測試。",
    whoShouldTry: ["投資人", "聽的比時間多的運營", "一直想做摘要工具的人"],
    usefulFor: "研究 / 運營",
    quote:
  ...
  "clothes-resale-scotty-beam": {
    ...
    howItWorks:
      "Scotty 說 Bot 看照片、認衣服、寫 listing，再和買家議價。他也指向自己較長的文章，比較 Grok Bot、Hermes、OpenClaw，以及自動化 X 內容。賣衣服是 Cursor 那個人的工；比較文是 Scotty 自己的。兩邊都沒有在這裡重跑。",
    whyUseful: "一堆衣服就是人人都懂的工：拖着的麻煩，一句「賣掉這些」。",
    whyItMatters: "這是轉述別人的 Bot，加上 Scotty 自己的長文。兩邊都寫清楚。",
    whoShouldTry: ["堆着二手貨的人", "一人運營", "拖着上架的人"],
    usefulFor: "二手 / 一人運營",
  ...
  "3d-game-roundtable-space": {
    title: "3D 遊戲，再自己上傳",
    headline: "0xMarioNawfal 寫 Grok @bot 做了 3D 遊戲、自己打、再把視頻上傳到 X",
    whatTheyDid:
      "2026 年 8 月 19 日，0xMarioNawfal（@RoundtableSpace）寫 Grok @bot 可以做成整個 3D 遊戲、自己錄屏自動玩、剪片，再上傳到 X——全部自己做。附件片段來自 Dan（@Daniel_Farinax）。",
    howItWorks: "Mario 轉發一段公開錄像。我們保留他原帖。沒有重跑那隻遊戲，也沒有重做上傳。",
    whyUseful: "這是人們會指着的電腦用工：不是聊天答案——是做好的遊戲，再加一條交得出的 X 視頻。",
    whyItMatters: "當日社區轉發一份具體 Bot 工。片段是 Dan 的；帖是 Mario 的。兩邊都寫清楚。",
  ...
  "five-bots-peter-yang": {
    title: "五隻實用 Bot",
    headline: "Peter Yang 出了五隻 Grok Bot 教程——顧問、YouTube、X、收件箱、旅行",
    whatTheyDid:
      "2026 年 8 月 17 日，Peter Yang（@petergyang）發教程：五隻有用的 Bot——一隻顧問負責開和管理其他 Bot、YouTube 研究找出局片、X 偵察找病毒和搞笑帖、「數碼 Marie Kondo」清收件箱和忘記的訂閱、再加上旅行禮賓。",
    howItWorks:
      "他也試過 Gamer Bot 玩經典遊戲，並問 Grok Bot 能不能取代 ChatGPT 做日常主力。我們摘要公開帖——沒有重跑他那五隻。",
    whyUseful: "五份有名的工，不是空泛「試試 agent」。想砌第一隊，抄這張名單。",
    whyItMatters: "這周人們在收藏的實用設置教程。社區文；我們保留 Peter 原帖。",
    whoShouldTry: ["剛砌第一隊 Bot 的人", "創作者", "運營"],
    usefulFor: "運營 / 創作者",
  ...
  "ultimate-guide-miles-deutscher": {
    title: "Grok Bot 完全指南",
    headline: "Miles Deutscher 發表〈Grok Bot: The Ultimate Guide〉——設置、插件、他那五隻",
    whatTheyDid:
      "2026 年 8 月 18 日，Miles Deutscher（@milesdeutscher）髮長文：Grok Bot 是什麼、怎樣設置、插件，以及他實際在跑的五隻——Alex 找 YouTube 出局片、Sandra 看樓盤、Jonathan 看投資組合、Lucy 分 Slack、Oscar 做雜務。",
    howItWorks:
      "他說從發布就開始試。文章就是工——設置、用例、插件，和老實的價錢。我們沒有重跑 Alex 或 Sandra。",
    whyUseful: "如果你想抄一張公開的桌——有名的 Bot、提示詞、插件——這篇是長讀。",
    whyItMatters: "這周另一篇人們在打開的 Grok Bot 長文。社區；我們保留 Miles 原帖。",
    whoShouldTry: ["已經有 Bot 的人", "想砌一小隊的運營", "創作者"],
    usefulFor: "運營 / 創作者",
    quote: "Grok Bot is the most powerful AI agent I've ever used.",
    result: "五隻有名的 Bot · 設置加插件",
  },
  "bot-team-tips-ben-lang": {
    title: "@bot 團隊提示",
    headline: "Ben Lang 收集了 @bot 團隊在傳的 Grok Bot 專業提示",
    whatTheyDid:
      "2026 年 8 月 18 日，Ben Lang（@benln）發了他從 @bot 團隊收集的清單：同一個插件接多個賬戶、一隻幕僚長加幾個專員、釘住常用 agent、用 Notion 記沒做完的工、示範一次教會，還有更多。",
    howItWorks:
      "他簡介寫着 Building SpaceXAI，via Cursor team。帖仍然是個人賬戶收集團隊提示——不是 @bot 或 @xai 原文——所以我們維持社區標籤，保留他原帖。",
    whyUseful: "短、抄得走的設置習慣。如果你的 Bot 仍然只是多一個聊天室，先做幕僚長，再加一頁 Notion「還有什麼沒做」。",
    whyItMatters: "這是公開轉述的團隊提示，不是 UseGrokBot 重測。沒有標官方，也沒有標已測試。",
    whoShouldTry: ["已經有 Bot 的人", "想砌一小隊的運營"],
    usefulFor: "運營",
  ...
  "ceo-desk-teslaconomics": {
    ...
    whatTheyDid:
      "2026 年 8 月 14 日，Teslaconomics（@Teslaconomics）寫他已經有六隻 Grok Bot，各做一工——提醒、圖像和視頻、估公司、分析視頻、幫忙發帖——再在上面放一隻 CEO Bot，他只跟一個收件箱聊。",
    howItWorks:
      "先專員，再幕僚長式 CEO 分派工作、交回一個包裹。他公開了第一條消息和三個例行（早、午、晚）。我們沒有重跑他的桌。",
    whyUseful: "沒有 CEO，你就是各組羣聊的中間人。這是公開可複製的做法：讓一隻 Bot 做收件箱。",
    whyItMatters: "有名的人、有名的名單、公開提示詞。社區——我們沒有重測 CEO。",
    whoShouldTry: ["已經跑超過一隻 Bot 的人", "運營", "創作者"],
    usefulFor: "運營 / 創作者",
  ...
  "agent-loops-alex-finn": {
    ...
    whatTheyDid:
      "2026 年 8 月 16 日，Alex Finn（@AlexFinn）寫 Grok Bot 天生適合循環：主 agent 叫另一隻每五分鐘循環一份工，再監察它。他說有一隻調度 Bot 看着工程 Bot 二十四小時，每三十分鐘想一個改進方法。",
    howItWorks:
      "他對比單一 Bot 用 /loop 自己看自己。多一隻 Bot 就是另一個上下文做判斷。我們摘要公開帖——沒有重跑他那二十四小時循環。",
    whyUseful: "如果你想工作自己繼續，又不想自己盯着 /loop，這就是兩隻 Bot 的版本。",
    whyItMatters: "有人公開在跑的具體循環做法。社區；我們沒有重測工程循環。",
  ...
  "grok-bot-walkthrough-alex-finn": {
    title: "設置走查",
    headline: "Alex Finn 發了 Grok Bot 設置視頻——用例和插件",
    whatTheyDid:
      "2026 年 8 月 18 日，Alex Finn（@AlexFinn）發了另一篇，不是那條五分鐘循環：一條視頻講怎樣設置 Grok Bot、用例、插件，以及設置對了才會好用。他說是一隊可以日夜開工的 agent。",
    howItWorks: "這是公開設置走查，不是客戶截圖。我們保留 Alex 原帖。沒有重跑他的桌，也沒有重剪視頻。",
    whyUseful: "如果你想一條片從設置開始——不是另一條五分鐘循環——這就是人們在看的那條。",
    whyItMatters: "這周最受注意的社區 Grok Bot 設置片。和循環卡是另一條帖。社區；沒有標已測試。",
    whoShouldTry: ["剛開第一隻 Bot 的人", "運營", "創作者"],
    usefulFor: "運營 / 創作者",
    quote: "In this video I cover setting up Grok Bot, use cases, plugins, and what makes Grok Bot so good",
    result: "視頻走查 · 設置、用例、插件",
  },
  "firstmate-kun-chen": {
    title: "Firstmate，一個收件箱",
    headline: "Kun Chen 公開可複製的 Firstmate 提示——你只跟一隻 Grok Bot 聊",
    whatTheyDid:
      "2026 年 8 月 18 日，Kun Chen（@kunchenguid）發了一個 Firstmate Bot 系統提示：開一隻、把 github.com/kunchenguid/firstmate 的 GROK_BOT.md 貼進描述，之後只跟這隻聊。它開、分派、協調其他 Bot。",
    howItWorks:
      "他說 Firstmate 是他在其他 harness 已用的幕僚長做法，現在變成一段短 Grok Bot 描述。我們沒有重跑 Firstmate。",
    whyUseful: "如果你不想十二個聊天室，這是公開提示：一隻 Bot 去請和調度其餘的。",
    whyItMatters: "有 repo、有提示、有名的人。社區——我們沒有重測 Firstmate。",
    whoShouldTry: ["已經有 Bot 的人", "想要一個收件箱的運營"],
    usefulFor: "運營",
  ...
  "calendar-booking-yunta-tsai": {
    ...
    whyUseful: "這是人們會指着的個人運營工：不是聊天摘要——是日曆上還要訂的位，走向車就已經處理。",
    whyItMatters: "Grok Bot 上線那周的公開電腦用例子。社區；沒有標已測試。",
  ...
  "parents-bot-yunta-tsai": {
    title: "給父母的第一隻 Bot",
    headline: "Yun-Ta Tsai 爲父母開了第一隻 Grok Bot——說它會中文，不用走插件迷宮",
    whatTheyDid:
      "2026 年 8 月 19 日，Yun-Ta Tsai（@yunta_tsai）寫 Grok Bot 是他會推薦給年長父母的第一個 AI 產品。他們已經會聊天。不想跳技能、插件、MCP。想問完就有人做完。他引用自己先前那條：給父母的第一隻 Bot，標了「乖兒子」。",
    howItWorks:
      "跟進帖是論點：自然、順、中文好，年長的人可以自己做完多數事，不用靠人。我們保留這條原帖。沒有幫他父母開 Bot。",
    whyUseful: "如果用戶是永遠不會配置 MCP 的父母，這就是公開的「問就行」例子。",
    whyItMatters: "和日曆訂位是同一個人。另一份工：給不用學技術棧的人用的 Bot。",
    whoShouldTry: ["幫父母開 Bot 的子女", "不會碰插件的人", "講中文的家庭"],
    usefulFor: "個人 / 家庭",
    quote: "Grok @bot is probably the first AI product I would recommend for senior parents.",
    result: "給父母的第一隻 Bot · 中文",
  },
  "eight-use-cases-eric-zakariasson": {
    title: "這周八個用例",
    headline: "eric zakariasson 發了這周八份 Grok Bot 工——第一份是發消息指揮吸塵機器人",
    whatTheyDid:
      "2026 年 8 月 19 日，eric zakariasson（@ericzakariasson）發了一串：這周八個很有趣的 Grok Bot 用例。第一個是把 Bot 接到吸塵機器人，再發消息叫 Grok 去哪裡清潔——引用 Yun-Ta Tsai 接 Matic 那條。",
    howItWorks:
      "其餘指向其他公開工：過 Google「我不是機器人」、整臺 Mac 當成人工作間、3D 遊戲、水管公司辦公室主任、追從未退款的商戶、招聘加清剩餘訂閱、以及五盤生意的夜班。我們摘要 Eric 的匯總——八份都沒有重跑。",
    whyUseful: "一串、八份具體工。想看這周人實際發過什麼，從這裡開始。",
    whyItMatters: "這是社區匯總，不是 Eric 自己的吸塵器。吸塵工是 Yun-Ta 的；名單是 Eric 的。兩邊都寫清楚。",
    whoShouldTry: ["在收集第一份工的人", "運營", "想掃這周公開例子的人"],
    usefulFor: "運營",
    quote: "here are 8 really interesting grok bot use cases from this week!",
    result: "八份公開工 · 從吸塵機器人開始",
  },
  "three-employees-scotty-beam": {
    ...
    whatTheyDid:
      "2026 年 8 月 18 日，SCOTTY BEAM（@ScottyBeamIO）寫有人教 Grok Bot 跑生意：自己做一次，讓 Bot 看着。三隻有名的員工：Gustavo 管運營（Notion 客戶中心、入職表格、第一次通話前準備）；Walter 管銷售（協議經 DocuSign，跟到客戶籤和付款）；Jesse 管線索（ManyChat 私信寫進 Notion，有人問價錢就立刻通知）。",
    howItWorks:
      "Scotty 說它們共用一臺雲端電腦和登錄。這條帖和賣沒穿過的衣服是另一條。我們保留這條原帖。沒有重跑 Gustavo、Walter 或 Jesse。",
    whyUseful: "有名的工、有名的工具。想砌第一隊銷售運營，抄這三條線。",
    whyItMatters: "熱度一般，桌很具體。社區轉述別人的團隊——我們留 Scotty 原帖，不會發明創始人是誰。",
    whoShouldTry: ["一人運營", "小銷售團隊", "想用示範教會 Bot 的人"],
    usefulFor: "運營 / 銷售",
  ...
  "math-explainer-yunta-tsai": {
    title: "給孩子的數學片",
    headline: "Yun-Ta Tsai 讓 Grok Bot 做數學講解片——用 Grok 語音 API 講得興高採烈",
    whatTheyDid:
      "2026 年 8 月 16 日，Yun-Ta Tsai（@yunta_tsai）寫孩子卡住怎麼把數字拆成冪次和，他又找不到好的講解。於是讓 Grok Bot 做一條。Bot 把想法做出來等他審——還用 Grok 語音 API 做了開朗的旁白。",
    howItWorks: "他說可以把擱着的想法丟給 Bot，它會做出來等你審。我們保留原帖和附件視頻。沒有重做那條講解。",
    whyUseful: "一條教學片就是你會拖的工。交出去，再審成品。",
    whyItMatters: "有名的人、有名的工、有附件視頻。社區；沒有標已測試。",
  ...
  "teach-a-task-eric-zakariasson": {
    title: "示範一次就教會",
    headline: "eric zakariasson 示範怎麼教 Grok Bot 一份工——點 +、錄瀏覽器，Bot 再做一次",
    whatTheyDid:
      "2026 年 8 月 13 日，eric zakariasson（@ericzakariasson）發了短教程：聊天室點 +，錄自己在瀏覽器怎麼做，Bot 看着就可以再做。他說多數工它自己做得完——當它卡住再用這招。",
    howItWorks:
      "這是帶片段的功能走查，不是客戶截圖。他簡介寫着 tinkering @spacexai；帖仍然是個人賬戶，所以我們維持社區標籤。",
    whyUseful: "Bot 一路點錯路徑，示範一次快過改提示詞。",
    whyItMatters: "有具體步驟，不是預告。社區；沒有標官方，也沒有標已測試。",
    whoShouldTry: ["Bot 一路走錯路的人", "想教會例行工作的運營", "非工程師"],
    usefulFor: "運營",
    quote:
  ...
  "support-refunds-gergely-orosz": {
    title: "客服收件箱，再退款",
    headline: "Gergely Orosz 把 Grok Bot 接到客服郵件——再經 Stripe API 做例行退款",
    whatTheyDid:
      "2026 年 8 月 19 日，Gergely Orosz（@GergelyOrosz）寫他把 Grok Bot 接到自己的客服郵件。Bot 可以經 API 連 Stripe，做 agentic 操作——例子是例行退款。附件截圖是 Stripe 的 agent 授權畫面：「Agent is now authorised to continue。」",
    howItWorks:
      "客服郵件入、Stripe API 出。他贊 Stripe 已經砌好這條 agentic 流程。我們保留 Gergely 原帖。沒有重跑他的收件箱，也沒有代發退款。",
    whyUseful:
      "客服加退款就是開店的人實際在做的工。這是具名的人，把 Bot 放進真正的收件箱和付款 API，不是空泛「試試 agent」。",
    whyItMatters: "當日社區例子：真正的客服收件箱，真正的 Stripe 授權畫面。社區；沒有標已測試。",
    whoShouldTry: ["自己兼客服的創始人", "已經在 Stripe 退款的運營", "客服隊列同時也是賬務隊列的人"],
    usefulFor: "支持 / 運營",
    quote:
  ...
  "remote-mower-sawyer-merritt": {
    title: "遠程開割草機",
    headline: "Sawyer Merritt 設置 Grok Bot，遠程控制五十英裏外的自動割草機器人",
    whatTheyDid:
      "2026 年 8 月 19 日，Sawyer Merritt（@SawyerMerritt）寫他把 Grok Bot 設成可以遠程控制五十英裏外的自動割草機器人。設置用了兩分鐘。他叫它開始割草，三秒後就動了。然後叫它自己回充電座。他說下一步會接吸塵器，再專用一隻 Grok Bot 管所有自動機器人。附件截圖是 Engineer Bot 對話：已連 Navimow X450，再「Start mowing now」和「Go dock」。片段是 Navimow X450 地圖。",
    howItWorks: "聊天進、割草機出。我們保留 Sawyer 原帖。沒有重跑那次開割或回座。",
    whyUseful: "遠程開和回座就是人人都懂的工：不是聊天摘要——是五十英裏外的機器，叫它割，再叫它回家。",
    whyItMatters: "當日社區例子：具名的人、在用的割草機、Engineer Bot 截圖。社區；沒有標已測試。",
    whoShouldTry: ["有割草機器人的人", "出門了但草地還要割的人", "想用一隻 Bot 管家用機器人的人"],
    usefulFor: "個人 / 家庭",
